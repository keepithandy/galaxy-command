...
Phase 4 — Factions & Diplomacy — is in progress. Phases 4A–4B now provide canonical bilateral relationships, deterministic diplomatic actions and drift, treaty proposals, non-aggression pacts, alliances, treaty expiry and breaking, war declarations, negotiated peace, save migration, and an interactive diplomacy HUD.
...
- `src/core/diplomacy.js` — bilateral relationships, diplomatic actions, treaty lifecycles, stance derivation, and war-state synchronization
