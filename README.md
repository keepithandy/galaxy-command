...
Phase 4 — Factions & Diplomacy — is in progress. Phase 4A now provides canonical bilateral relationships, deterministic diplomatic actions, relationship drift, symmetric war state, save migration, and an interactive diplomacy HUD.
...
- `src/core/diplomacy.js` — bilateral relationships, diplomatic actions, stance derivation, and war-state synchronization
